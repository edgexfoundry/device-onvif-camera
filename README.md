...
> **WARNING:** The `main` branch contains work-in-progress development code and is not guaranteed to be stable.
> Please look for the latest stable releases [here](https://github.com/edgexfoundry/device-onvif-camera/releases).

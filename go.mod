...
require (
	...
	github.com/edgexfoundry/device-sdk-go/v4 v4.1.0-dev.54
	github.com/edgexfoundry/go-mod-bootstrap/v4 v4.1.0-dev.51
...
require (
	...
	github.com/openziti/sdk-golang v1.4.0 // indirect

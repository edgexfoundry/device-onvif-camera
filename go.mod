...
require (
	...
	github.com/edgexfoundry/device-sdk-go/v3 v3.0.0-dev.72
	github.com/edgexfoundry/go-mod-bootstrap/v3 v3.0.0-dev.68
...
require (
	...
	github.com/edgexfoundry/go-mod-messaging/v3 v3.0.0-dev.24 // indirect
